...
<b>输出：</b>[0,-1,-1,1]
<b>解释：</b><span><code>k = 4，所以只有一种可行的翻转操作，就是将整个数组翻转。一开始 </code></span>1<strong> </strong>在位置 0 处，所以将它翻转到位置 0 处需要的操作数为 0 。
...
<div><div>Related Topics</div><div><li>广度优先搜索</li><li>数组</li><li>有序集合</li></div></div><br><div><li>👍 53</li><li>👎 0</li></div>